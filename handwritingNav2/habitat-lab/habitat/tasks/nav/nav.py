...
class SPL(Measure):
    ...
    def update_metric(
        ...
        # Handle case where start and end positions are identical (or very close)
        if self._start_end_episode_distance < 1e-8:  # Small epsilon to handle numerical precision
            self._metric = ep_success  # If successful and distance is 0, SPL is 1
        else:
